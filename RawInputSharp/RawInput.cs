...
namespace RawInputSharp {
	...
	public abstract class RawInput {
		...
		// Raw Input constants from winuser.h
		...
		public extern static Int32 GetRawInputData([In] IntPtr hRawInput, [In] Int32 uiCommand, IntPtr pRawInput, [In, Out] ref Int32 pcbSize, [In] Int32 cbSizeHeader);
		[DllImport("User32.dll",EntryPoint="GetRawInputData",CharSet=CharSet.Unicode,SetLastError=true)]
		public extern static Int32 GetRawInputData([In] IntPtr hRawInput, [In] Int32 uiCommand, [In,Out] ref RAWINPUT rawInput, [In, Out] ref Int32 pcbSize, [In] Int32 cbSizeHeader);
